...
import { DisabledReasonModalComponent } from './disabled-reason-modal/disabled-reason-modal.component';
...
export class CreateEditPolicyComponent implements OnInit, OnDestroy {
    ...
    getPolicyDetails(policyId: any) {
        const url = environment.getPolicyDetailsById.url;
        const method = environment.getPolicyDetailsById.method;
    ...
    getAccounts() {
        try {
            ...
            const payload = {
                ...
                payload:
                    '{"size":0,"aggs":{"alldata":{"terms":{"field":"' +
                    field +
                    '","size":10000}}}}',
            };
