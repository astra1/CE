...
describe('IssueListingComponent', () => {
    ...
    // disabled due forbidden on prefix (onScrollDataLoader)
    xit('renders an independent table component', () => {
        component.getData();
        fixture.detectChanges();
    ...
    // disabled due forbidden on prefix (onScrollDataLoader)
    xit('should call CommonResponseService getData method', () => {
        fixture.detectChanges();
    ...
    // disabled due forbidden on prefix (onScrollDataLoader)
    xit('should tell ROUTER to navigate when row clicked', fakeAsync(() => {
        const router = TestBed.inject(Router);
        spyOn(router, 'navigate').and.stub();
        const tile = { 'Violation ID': 'e022bb6348a055c42b8f22e2cbab01ad' };
