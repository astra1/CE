...
import { DevPullRequestApplicationsComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/dev-pull-request-applications/dev-pull-request-applications.component';
import { DevStaleBranchApplicationsComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/dev-stale-branch-applications/dev-stale-branch-applications.component';
import { DevStandardPullRequestAgeComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/dev-standard-pull-request-age/dev-standard-pull-request-age.component';
import { DevStandardStaleBranchAgeComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/dev-standard-stale-branch-age/dev-standard-stale-branch-age.component';
import { DevStandardTotalStaleBranchesComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/dev-standard-total-stale-branches/dev-standard-total-stale-branches.component';
import { DigitalApplicationDistributionComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/digital-application-distribution/digital-application-distribution.component';
import { DigitalDevStrategyDistributionComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/digital-dev-strategy-distribution/digital-dev-strategy-distribution.component';
import { PullRequestLineMetricsComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/pull-request-line-metrics/pull-request-line-metrics.component';
...
import { FilteredSelectorComponent } from 'projects/pacman-spa/src/app/shared/filtered-selector/filtered-selector.component';
import { GenericPageFilterComponent } from 'projects/pacman-spa/src/app/shared/generic-page-filter/generic-page-filter.component';
import { SearchableDropdownComponent } from 'projects/pacman-spa/src/app/shared/searchable-dropdown/searchable-dropdown.component';
...
import { WidgetSectionStarterComponent } from 'projects/pacman-spa/src/app/shared/widget-section-starter/widget-section-starter.component';
