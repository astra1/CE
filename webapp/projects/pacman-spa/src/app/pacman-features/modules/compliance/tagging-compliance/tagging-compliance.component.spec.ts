...
import { TaggingAcrossTargetTypeComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/tagging-across-target-type/tagging-across-target-type.component';
import { TaggingAssetsTrendComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/tagging-assets-trend/tagging-assets-trend.component';
import { TaggingComplianceTrendComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/tagging-compliance-trend/tagging-compliance-trend.component';
import { TaggingInstancesTableComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/tagging-instances-table/tagging-instances-table.component';
import { TaggingSummaryComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/tagging-summary/tagging-summary.component';
import { TotalTagComplianceComponent } from 'projects/pacman-spa/src/app/pacman-features/secondary-components/total-tag-compliance/total-tag-compliance.component';
